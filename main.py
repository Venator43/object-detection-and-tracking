...
track_states = {}
def live_stream_tracking():
    global polygon, polygon_metadata, count_in, count_out
...
@app.route('/video')
def video():
    return Response(live_stream_tracking(),
                    mimetype='multipart/x-mixed-replace; boundary=frame')

@app.route('/')
def index():
    return '<img src="/video" width="640" height="480">'
